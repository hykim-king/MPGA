...
.btn-default {
    ...
    <div class="row"><h1 class="text-center">시식회 안내</h1>
            ...
            <div class="panel panel-info coupon">
              <div class="panel-heading" id="head">
                <div class="panel-title" id="title">
                    ...
                    <span class="hidden-xs">시식회 초대이벤트</span>
                    <span class="visible-xs">시식회 초대이벤트</span>
                </div>
              </div>
              <div class="panel-body">
                <img src="eventImage/baeck.png" class="coupon-img img-rounded">
                <div class="col-md-9">
                    <ul class="items">
                    <li><b>이벤트 등록창에 코드를 입력해주세요!</b></li>
                        <li><b>다함께 신메뉴를 즐깁시다!</b></li>

                    </ul>
                </div>
                <div class="col-md-3">
                    <div class="offer text-info">
                        <span class="number">tasting!</span>
                    </div>
                </div>
                <div class="col-md-12">
              ...
              <div class="panel-footer">
                ...
                <div class="exp">이벤트날짜: Sep 30, 2021</div>
              </div>
            </div>
        </div>
    </div>
