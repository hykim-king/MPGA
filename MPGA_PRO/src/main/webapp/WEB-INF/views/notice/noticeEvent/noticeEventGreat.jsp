...
<div class="container">
    ...
    <div class="row"><h1 class="text-center">우수회원 쿠폰이벤트</h1>
            ...
            <div class="panel panel-danger coupon">
              <div class="panel-heading" id="head">
                <div class="panel-title" id="title">
                    ...
                    <span class="hidden-xs">우수회원 한정 랜덤으로 쿠폰이 지급됩니다!</span>
                    <span class="visible-xs">우수회원 한정 랜덤으로 쿠폰이 지급됩니다!</span>
                </div>
              </div>
              ...
              <div class="panel-footer">
                ...
                <div class="exp">만료날짜: Dec 30, 2021</div>
              </div>
            </div>
        </div>
    </div>
