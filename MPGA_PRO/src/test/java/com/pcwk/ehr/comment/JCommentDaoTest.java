...
public class JCommentDaoTest {
	...
	public void setUp() throws Exception {
		menucomment01 = new MenuCommentVO(1, "LOGO_01", 1, "", "");
		menucomment02 = new MenuCommentVO(2, "LOGO_02", 2, "", "");
		menucomment03 = new MenuCommentVO(3, "LOGO_03", 3, "", "");
	...
	public void doUpdate() throws SQLException, ClassNotFoundException {
		...
		// 수정 + 업데이트
		menucomment01.setSeq(menucomment01.getSeq());
		menucomment01.setMenuNum(menucomment01.getMenuNum() + "_U");
		menucomment01.setMemberNum(menucomment01.getMemberNum());
		menucomment01.setContents(menucomment01.getContents() + "_U");
		menucomment01.setRegDt(menucomment01.getRegDt() + "_U");
